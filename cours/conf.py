...
project = 'ELP'
copyright = '2018, Tristan Roussillon'
...
latex_documents = [
    (master_doc, 'ELP.tex', 'ELP introduction',
     'Tristan Roussillon', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'ELP', 'ELP introduction',
     author, 'ELP', 'One line description of project.',
     'Miscellaneous'),
]
